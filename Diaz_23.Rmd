---
title: Living in the Mountains. Settlement patterns in Northwestern Iberia during the
  Palaeolithic period. Source code and data.
...
Import the packages to execute the following analysis.
...
# usage
packages <- c("GGally", "readxl", "rgdal", "rgeos", "sp", "spatstat", "tidyverse", "dismo", "MASS", "ggplot2", "plyr", "maps", "maptools", "raster", "geostatsp", "patchwork", "foreach", "purrrlyr", "Rcmdr")
ipak(packages)
```

# Complete Spatial Randomness

Process to check if Complete Spatial Randomness (CSR) exists.
...
#Boxplot
## set the working directory
setwd("~/mountain_ranges/csv")

## Import files
boxplot_variables_northern <- read.csv(file = "~/csv/boxplot_variables_northern.csv",header=TRUE, sep=";", stringsAsFactors=F, dec=",")
boxplot_variables_central <- read.csv(file = "~/csv/boxplot_variables_central.csv",header=TRUE, sep=";", stringsAsFactors=F, dec=",")
...
```{r echo=TRUE, results='hide'}
## Import files
boxplot_northern_vs_central <- read.csv(file = "~/csv/boxplot_northern_vs_central.csv",header=TRUE, sep=";", stringsAsFactors=F, dec=",")
...
Statistical test calculations in each area.
...
## Import files
## Import files
test_central <- read.csv(file = "~/csv/boxplot_variables_central.csv",header=TRUE, sep=";", stringsAsFactors=F, dec=",")
```
...
```{r echo=TRUE, results='hide'}
## Import files
variables_northern <- read.csv(file = "~/csv/table_variables_northern.csv",header=TRUE, sep=";", stringsAsFactors=F, dec=",")
...
```{r echo=TRUE, results='hide'}
## Import files
variables_central <- read.csv(file = "~/csv/table_variables_central.csv",header=TRUE, sep=";", stringsAsFactors=F, dec=",")
...
### Northern area random sites

```{r echo=TRUE, results='hide'}
## Import files
random_sites_northern <- read.csv(file = "~/csv/random_sites_variables_northern.csv",header=TRUE, sep=";", stringsAsFactors=F, dec=",")
...
### Central area random sites

```{r echo=TRUE, results='hide'}
## Import files
random_sites_central <- read.csv(file = "~/csv/random_sites_variables_central.csv",header=TRUE, sep=";", stringsAsFactors=F, dec=",")
